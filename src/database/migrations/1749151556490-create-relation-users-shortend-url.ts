...
export class CreateRelationUsersShortendUrl1749151556490
  implements MigrationInterface
{
  name = 'CreateRelationUsersShortendUrl1749151556490';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "shortened_url" ADD "userId" uuid NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "shortened_url" DROP COLUMN "userId"`);
  }
}
